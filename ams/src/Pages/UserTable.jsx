...
import { UserCircle, Mail, Phone, UserPlus, Search, Filter } from "lucide-react";
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        setUsers(() => response.data.users.filter((user) => user.user_type === "customer"));
      } catch (error) {
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <Badge className="mt-1 bg-blue-500 hover:bg-blue-600">Active</Badge>
                </div>
              </div>
            </CardContent>
          </Card>
